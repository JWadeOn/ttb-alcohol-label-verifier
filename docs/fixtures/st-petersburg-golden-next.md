...
| **Suggested file** | `fixtures/labels/on-bottle/st_petersburg_whiskey_label_dark_baseline.png` |
...
| **Suggested file** | `fixtures/labels/on-bottle/st_petersburg_whiskey_label_dark_glare.png` |
...
| **Suggested file** | `fixtures/labels/on-bottle/st_petersburg_whiskey_label_kraft_baseline.png` |
...
| **Suggested file** | `fixtures/labels/on-bottle/st_petersburg_vodka_label_dark_baseline.png` |
...
| **Suggested file** | `fixtures/labels/on-bottle/st_petersburg_vodka_baseline.png` |
...
| **Suggested file** | `fixtures/labels/on-bottle/st_petersburg_whiskey_angle_28.png` |
...
| **Suggested file** | `fixtures/labels/on-bottle/st_petersburg_whiskey_crop_missing_warning.png` |
...
| **Suggested file** | `fixtures/labels/on-bottle/st_petersburg_whiskey_blur_strong.png` |
...
| **Suggested file** | `fixtures/labels/on-bottle/st_petersburg_whiskey_low_light_grain.png` |
...
| **Suggested file** | `fixtures/labels/on-bottle/st_petersburg_vodka_glare_brand.png` |
...
1. Save as `fixtures/labels/on-bottle/<filename>.png`.
