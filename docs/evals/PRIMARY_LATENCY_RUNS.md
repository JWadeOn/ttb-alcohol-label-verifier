...
| 2026-05-12T15:44:30Z | [`primary-latency-production-2026-05-12.json`](./primary-latency-production-2026-05-12.json) | 3 (happy path + seeds) | openai ×3 | 6330 | Defaults **8000 / 20000** ms + happy path in eval set (`265885e`). |
