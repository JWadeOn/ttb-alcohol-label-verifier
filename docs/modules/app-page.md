...
- Includes a lightweight **Batch verify (MVP)** panel in Edit mode: select multiple images, submit to `POST /api/verify/batch`, and render per-file status with aggregate summary.
